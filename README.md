...
```bash
git clone https://github.com/MihaiHng/foundry-merkle-airdrop-f24.git
cd foundry-merkle-airdrop-f24
...
In this project you will find functionality for deploying on anvil. 
Deploying to a zkSync local node or to zkSync Sepolia will need additional scripts mentioned below but not implemented here. At the time of writing deploying using scripts it's ideal on zkSync.
